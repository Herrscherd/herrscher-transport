...
const (
	Plugin_Call_FullMethodName = "/herrscher.transport.v1.Plugin/Call"
)
...
type PluginClient interface {
	Call(ctx context.Context, in *MethodEnvelope, opts ...grpc.CallOption) (*ResultEnvelope, error)
}
...
func (c *pluginClient) Call(ctx context.Context, in *MethodEnvelope, opts ...grpc.CallOption) (*ResultEnvelope, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResultEnvelope)
	err := c.cc.Invoke(ctx, Plugin_Call_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PluginServer interface {
	Call(context.Context, *MethodEnvelope) (*ResultEnvelope, error)
...
func (UnimplementedPluginServer) Call(context.Context, *MethodEnvelope) (*ResultEnvelope, error) {
...
func _Plugin_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PluginServer).Call(ctx, req.(*MethodEnvelope))
	}
...
var Plugin_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "herrscher.transport.v1.Plugin",
